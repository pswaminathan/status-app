...
(defn get-data [url]
  ...
  (client/get url
    {:headers {:x-api-key "i3x6x4eblN3HCrdEkJWeE7NsyH5WAego5gV5WX8t"}
     :as :json}))

(defn send-to-dynamodb-table
...
(defn -main []
  ...
  (let [response (get-data "https://xer76gpr57.execute-api.us-east-1.amazonaws.com/prod/healthcheck")
